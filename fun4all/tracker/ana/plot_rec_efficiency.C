...
void plot_rec_efficiency(double xmin, double ymin, double xmax, double ymax, const char *figname);

void
plot_rec_efficiency()
{
  plot_rec_efficiency(0.03, 10., 30., 110., "plot_rec_efficiency.png");
}

void
plot_rec_efficiency(double xmin, double ymin, double xmax, double ymax, const char *figname)
{
  style();
  ...
  auto g_rp_el_beam29 = (TH1 *)efficiency("pid=11_pipe=2.9_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoRecPt")->Clone("g_rp_el_beam29");
  g_rp_el_beam29->Scale(1.e2);
  g_rp_el_beam29->SetMarkerStyle(25);
  g_rp_el_beam29->SetMarkerColor(kGray+2);
  g_rp_el_beam29->SetLineColor(kBlack);
  ...
  auto g_rp_pi_beam29 = (TH1 *)efficiency("pid=211_pipe=2.9_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoRecPt")->Clone("g_rp_pi_beam29");
  ...
  auto g_rp_ka_beam29 = (TH1 *)efficiency("pid=321_pipe=2.9_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoRecPt")->Clone("g_rp_ka_beam29");
  ...
  auto g_rp_pr_beam29 = (TH1 *)efficiency("pid=2212_pipe=2.9_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoRecPt")->Clone("g_rp_pr_beam29");
