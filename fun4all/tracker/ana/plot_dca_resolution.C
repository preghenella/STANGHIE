...
void
plot_dca_resolution(double xmin = 0.03, double ymin = 1., double xmax = 30., double ymax = 1.e3)
{
  style();

  // Ruben's results
  auto f_rs = TFile::Open("rs.dr.root");
  ...
  c->cd(1)->DrawFrame(xmin, ymin, xmax, ymax, ";#it{p}_{T} (GeV/c); r#varphi pointing resolution (#mum)");
  c->cd(1)->SetLogx();
  c->cd(1)->SetLogy();
  c->cd(1);
  
  auto g_rp_el_beam16 = (TH1 *)resolution("pid=11_pipe=1.6_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoDcaPt")->Clone("g_rp_el_beam16");
  g_rp_el_beam16->Scale(1.e4);
  ...
  auto g_rp_el_beam29 = (TH1 *)resolution("pid=11_pipe=2.9_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoDcaPt")->Clone("g_rp_el_beam29");
  g_rp_el_beam29->Scale(1.e4);
  ...
  auto g_rs_el_beam16 = (TGraph *)f_rs->Get("el5pointRRes0");
  ...
  auto g_rs_el_beam29 = (TGraph *)f_rs->Get("el5bsppointRRes0");
  ...
  c->cd(2)->DrawFrame(xmin, ymin, xmax, ymax, ";#it{p}_{T} (GeV/c); r#varphi pointing resolution (#mum)");
  c->cd(2)->SetLogx();
  c->cd(2)->SetLogy();
  c->cd(2);
  
  auto g_rp_pi_beam16 = (TH1 *)resolution("pid=211_pipe=1.6_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoDcaPt")->Clone("g_rp_pi_beam16");
  g_rp_pi_beam16->Scale(1.e4);
  ...
  auto g_rp_pi_beam29 = (TH1 *)resolution("pid=211_pipe=2.9_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoDcaPt")->Clone("g_rp_pi_beam29");
  g_rp_pi_beam29->Scale(1.e4);
  ...
  auto g_rs_pi_beam16 = (TGraph *)f_rs->Get("pi5pointRRes0");
  ...
  auto g_rs_pi_beam29 = (TGraph *)f_rs->Get("pi5bsppointRRes0");
  ...
  c->cd(3)->DrawFrame(xmin, ymin, xmax, ymax, ";#it{p}_{T} (GeV/c); r#varphi pointing resolution (#mum)");
  c->cd(3)->SetLogx();
  c->cd(3)->SetLogy();
  c->cd(3);
 
  auto g_rp_ka_beam16 = (TH1 *)resolution("pid=321_pipe=1.6_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoDcaPt")->Clone("g_rp_ka_beam16");
  g_rp_ka_beam16->Scale(1.e4);
  ...
  auto g_rp_ka_beam29 = (TH1 *)resolution("pid=321_pipe=2.9_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoDcaPt")->Clone("g_rp_ka_beam29");
  g_rp_ka_beam29->Scale(1.e4);
  ...
  c->cd(4)->DrawFrame(xmin, ymin, xmax, ymax, ";#it{p}_{T} (GeV/c); r#varphi pointing resolution (#mum)");
  c->cd(4)->SetLogx();
  c->cd(4)->SetLogy();
  c->cd(4);
  
  auto g_rp_pr_beam16 = (TH1 *)resolution("pid=2212_pipe=1.6_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoDcaPt")->Clone("g_rp_pr_beam16");
  g_rp_pr_beam16->Scale(1.e4);
  ...
  auto g_rp_pr_beam29 = (TH1 *)resolution("pid=2212_pipe=2.9_field=0.2_eta=0.5.trackerAnalysis.root", "mHistoDcaPt")->Clone("g_rp_pr_beam29");
  g_rp_pr_beam29->Scale(1.e4);
  ...
  auto g_rs_pr_beam16 = (TGraph *)f_rs->Get("p5pointRRes0");
  ...
  auto g_rs_pr_beam29 = (TGraph *)f_rs->Get("p5bsppointRRes0");
  ...
  c->SaveAs("plot_dca_resolution.png");
